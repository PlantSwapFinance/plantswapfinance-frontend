...
const Nfts: Nft[] = [
  ...
  {
    name: 'Sleepy',
    description: 'Aww, looks like eating plants all day is tough work. Sweet dreams!',
    images: {
      lg: 'sleepy-lg.png',
      md: 'sleepy-md.png',
      sm: 'sleepy-sm.png',
  ...
  {
    name: 'Sunny',
    description: 'Sunny is always cheerful when there are plants around. Smile!',
    images: {
      lg: 'sunny-lg.png',
      md: 'sunny-md.png',
      sm: 'sunny-sm.png',
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master PLANT chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of PLANT.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's PLANT)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
  ...
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping plants. Especially on BSC.',
    images: {
      lg: 'swapsies-lg.png',
      md: 'swapsies-md.png',
      sm: 'swapsies-sm.png',
  ...
  {
    name: 'Blueberries',
    description: "These bunnies like their plants with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: 'Circular',
    description: "Love makes the world go 'round... but so do plants. And these bunnies know it.",
    images: {
      lg: 'circular-lg.png',
      md: 'circular-md.png',
      sm: 'circular-sm.png',
  ...
  {
    name: 'Sparkle',
    description: 'It’s sparkling syrup, plants, and even lottery tickets! This bunny really loves it.',
    images: {
      lg: 'sparkle-lg.png',
      md: 'sparkle-md.png',
      sm: 'sparkle-sm.png',

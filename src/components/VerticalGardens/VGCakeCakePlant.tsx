    ...
    <group ref={group} {...props} dispose={null}>
      ...
      <group> 
        ...
        <group> 
          ...
          <CakeSpin position={[0.5, 0.6, 0]} scale={[0.5, 0.5, 1]} />
          <CakeSpin position={[-0.5, 0.6, 0]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <CakeSpin position={[0, 0.6, 0.5]} scale={[0.5, 0.5, 1]} />
          <CakeSpin position={[0, 0.6, -0.5]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          
          <CakeSpin position={[0.85, 0.6, 0.85]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <CakeSpin position={[0.85, 0.6, -0.85]} scale={[0.5, 0.5, 1]} />
          <CakeSpin position={[-0.85, 0.6, 0.85]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <CakeSpin position={[-0.85, 0.6, -0.85]} scale={[0.5, 0.5, 1]} />
        </group>
...
export default VGCakeCakePlant;

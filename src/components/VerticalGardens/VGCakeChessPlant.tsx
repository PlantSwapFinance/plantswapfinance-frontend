...
import Cake from 'components/Assets3D/CAKE'
import ChessSpin from 'components/Assets3D/CHESSspin'
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group> 
        ...
        <group> 
          <Cake position={[0, 0, 1.25]} scale={[0.75, 0.75, 1.5]} />
          <Cake position={[0, 0, -1.25]} scale={[0.75, 0.75, 1.5]} />
          <Cake position={[1.25, 0, 0]} scale={[0.75, 0.75, 1.5]} rotation={[0, Math.PI / 2, 0]} />
          <Cake position={[-1.25, 0, 0]} scale={[0.75, 0.75, 1.5]} rotation={[0, Math.PI / 2, 0]} />
          ...
          <ChessSpin position={[0.5, 0.6, 0]} scale={[0.5, 0.5, 1]} />
          <ChessSpin position={[-0.5, 0.6, 0]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <ChessSpin position={[0, 0.6, 0.5]} scale={[0.5, 0.5, 1]} />
          <ChessSpin position={[0, 0.6, -0.5]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          
          <ChessSpin position={[0.85, 0.6, 0.85]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <ChessSpin position={[0.85, 0.6, -0.85]} scale={[0.5, 0.5, 1]} />
          <ChessSpin position={[-0.85, 0.6, 0.85]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <ChessSpin position={[-0.85, 0.6, -0.85]} scale={[0.5, 0.5, 1]} />
        </group>
...
export default VGCakeChessPlant;

...
import OddzSpin from 'components/Assets3D/ODDZspin'
    ...
    <group ref={group} {...props} dispose={null}>
      ...
      <group> 
        ...
        <group> 
          ...
          <OddzSpin position={[0.5, 0.6, 0]} scale={[0.5, 0.5, 1]} />
          <OddzSpin position={[-0.5, 0.6, 0]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <OddzSpin position={[0, 0.6, 0.5]} scale={[0.5, 0.5, 1]} />
          <OddzSpin position={[0, 0.6, -0.5]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          
          <OddzSpin position={[0.85, 0.6, 0.85]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <OddzSpin position={[0.85, 0.6, -0.85]} scale={[0.5, 0.5, 1]} />
          <OddzSpin position={[-0.85, 0.6, 0.85]} scale={[0.5, 0.5, 1]} rotation={[0, Math.PI / 2, 0]} />
          <OddzSpin position={[-0.85, 0.6, -0.85]} scale={[0.5, 0.5, 1]} />
        </group>
...
export default VGCakeOddzPlant;

...
type GLTFResult = GLTF & {
  nodes: {
    ...
    PlantLogo: THREE.Mesh
    DoorBeamLeft: THREE.Mesh
    DoorFrameLeft: THREE.Mesh
    DoorWindows: THREE.Mesh
    DoorBeemRight: THREE.Mesh
    DoorFrameRight: THREE.Mesh
    PlantLogoBack: THREE.Mesh
    DoorBeamBackLeft: THREE.Mesh
    DoorFrameBackLeft: THREE.Mesh
    DoorBeamBackRight: THREE.Mesh
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh
        ...
        scale={[-0.03, 0.79, 0.4]}
      />
      <Plant position={[-1, 0.93, 0]} rotation={[Math.PI / 2, Math.PI / 2, -Math.PI / 2]} scale={0.6} />
      <Plant position={[1, 0.93, 0]} rotation={[Math.PI / 2, Math.PI / 2, -Math.PI / 2]} scale={0.6} />
    </group>
  )
}

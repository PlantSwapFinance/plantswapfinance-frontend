...
const ShareModal: React.FC<ShareModalProps> = ({ harvested, type, onDismiss, tokenName, tokenHarvested, usdHarvested }) => {
  ...
  if(type === "share") { 
    typeLabbel = "discovered"
    shareTitle = `I just discovered PlantSwap.finance, the $PLANT Token and the project, let's help the planet🌱🌱🌱` }
  ...
  const workplaceHashtag = "#PlantSwap #PLANT #DeFi #YieldFarming #LiquidityMining"

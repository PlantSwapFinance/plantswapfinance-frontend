...
import { Button, Flex, Heading, useModal, Won } from '@plantswap-libs/uikit'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndPlantModal onSuccess={checkClaimStatus} />)

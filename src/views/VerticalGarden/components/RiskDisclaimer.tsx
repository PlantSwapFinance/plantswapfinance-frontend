...
const RiskDisclaimer: React.FC<RiskDisclaimerProps> = ({ onSuccess, onDismiss }) => {
  ...
  return (
    <Modal title={TranslateString(999, 'Welcome to the Vertical Garden!')} minWidth="320px">
          <Heading size="lg">{TranslateString(556, "Let's start with a disclaimer")}
          <br /></Heading>
        <Box maxHeight="300px" overflowY="auto">
          <Heading as="h3" mb="24px">
          <br />
            {TranslateString(999, "The Vertical Garden is new, we did a good amount of testing locally and on testnet but little testing has been done yet on mainnet.")}
          </Heading>

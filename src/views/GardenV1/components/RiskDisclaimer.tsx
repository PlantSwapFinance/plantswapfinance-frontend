  ...
  return (
    <Modal title={TranslateString(999, 'Welcome to the Garden!')} minWidth="320px">
        ...
        <Box maxHeight="300px" overflowY="auto">
          ...
          <br />
            {TranslateString(999, "We are currently experiencing issues with the automatic payout of the garden reward. For the moment, none of the 3 available gardens offer automatic reward. However the dev team will do the payout of the due reward on a sporadic frequency. (we promise a minimum of two payout per week and a maximum frequency of ounce per day, please understand that at time of writing these lines of code yet to be commit to github, there are already a few hundred of contributions to the different garden to calculate how much reward is due and process each transaction.")}
          </Heading>

...
import { Modal, Text, Button, Flex, InjectedModalProps } from '@plantswap-libs/uikit'
...
const bullNft = nftList.find((nft) => nft.farmerId === BULL_NFT)
const hiccupNft = nftList.find((nft) => nft.farmerId === HICCUP_NFT)

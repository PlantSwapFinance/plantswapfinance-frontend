...
import { Box, Flex, InjectedModalProps, Modal, Button, Spinner } from '@plantswap/uikit'
...
const VoteDetailsModal: React.FC<VoteDetailsModalProps> = ({ block, onDismiss }) => {
  ...
  const { isLoading, total, plantBalance, plantVaultBalance, plantPoolBalance, poolsBalance, plantBnbLpBalance } =
        ...
        {isLoading ? (
          ...
          <>
            <DetailsView
              ...
              plantVaultBalance={plantVaultBalance}
              plantPoolBalance={plantPoolBalance}
              poolsBalance={poolsBalance}
              plantBnbLpBalance={plantBnbLpBalance}
            />

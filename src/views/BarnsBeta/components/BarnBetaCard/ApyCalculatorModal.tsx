...
import { calculatePlantEarnedPerThousandDollars, apyModalRoi } from 'utils/compoundApyHelpersBarnBeta'
...
const ApyCalculatorModal: React.FC<ApyCalculatorModalProps> = ({
  ...
  const plantEarnedPerThousand1D = calculatePlantEarnedPerThousandDollars({ numberOfDays: 1, barnBetaApy: apy, plantPrice })
  const plantEarnedPerThousand7D = calculatePlantEarnedPerThousandDollars({ numberOfDays: 7, barnBetaApy: apy, plantPrice })
  const plantEarnedPerThousand30D = calculatePlantEarnedPerThousandDollars({ numberOfDays: 30, barnBetaApy: apy, plantPrice })

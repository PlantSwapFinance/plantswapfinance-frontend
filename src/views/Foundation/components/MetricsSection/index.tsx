...
import { Heading, Flex, Text, Skeleton, ChartIcon, CommunityIcon, SwapIcon } from '@plantswap/uikit'
  ...
  return (
    <Flex justifyContent="center" alignItems="center" flexDirection="column">
      ...
      <Text textAlign="center" color="textSubtle">
        {t('PlantSwap has the most users of any decentralized platform, ever.')}
      </Text>
      <Flex flexWrap="wrap">
